      ...
      <form action="/profile/update/<?= user()->id; ?>" method="POST">
        ...
        <div class="inputan">
          ...
          <div class="input">
            ...
            <input type="date" name="birthday" id="birthday" class="" value="<?= user()->birthday; ?>" required />
          </div>          
          <div class="input">
          ...
          <label for="instagram" method="POST" class="">Instagram</label>
              <input type="text" name="instagram" id="instagram" value="<?= user()->instagram; ?>" class="" placeholder="Masukkan instagram aktif" required />
          </div>
          <div class="input">
          <label for="country" method="POST" class="">Negara</label>
              <input type="text" name="country" id="country" value="<?= user()->country; ?>" placeholder="Negara Asal" class="" required />
          </div>
          <div class="input">
          <label for="city" method="POST" class="">Kota</label>
              <input type="text" name="city" id="city" value="<?= user()->city; ?>" class="" placeholder="Kota Asal" required />
          </div>
